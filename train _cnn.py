...
from models.pretrain_models_cnn import VTT, VTMAE, MAEPolicy
...
def main():
    ...
    # MAE.
    parser.add_argument("--representation", type=str2bool, default=False)
    ...
    # PPO.
    parser.add_argument("--rollout_length", type=int, default=256)    # 32768
