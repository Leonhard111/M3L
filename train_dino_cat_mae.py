...
from models.ppo_dino_cat_mae_improved import PPO_MAE
...
from models.pretrain_models_dino_cat_mae import VTT, VTMAE, MAEPolicy
...
def main():
    ...
    parser.add_argument("--masking_ratio", type=float, default=0.8)
